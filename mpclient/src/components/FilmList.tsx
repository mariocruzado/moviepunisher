...
const FilmList: React.FC<IPropsGlobal> = props => {
  ...
  return (
    <div className="container">
      <div className="columns is-centered" css={css`margin-top:40px !important;`}>
            ...
            <div className="cellphone-container">
              <div className="movie">
                <div className="menu">
                  ...
                  <img
                    className="movie-img"
                    src={f.poster_path? `https://image.tmdb.org/t/p/w400/${f.poster_path}`:`http://roblucastaylor.com/wp-content/uploads/2017/07/cover-image-unavailable.jpg`}
                  />
